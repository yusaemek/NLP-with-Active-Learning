...
print(y)
vectorizer=tfidfvec(max_features=5000,min_df=3,ngram_range=(1, 2))
vectorizer.fit(X)
X_Vect = vectorizer.transform(X)
print("vectorized")

al = AlExperiment(X_Vect, y, stopping_criteria='num_of_queries', stopping_value=150, batch_size=10)
